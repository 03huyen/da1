...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 19, 2023 lúc 09:26 AM
...
INSERT INTO `category` (`category_id`, `name`, `cat_slug`) VALUES
(1, 'Laptops', 'laptops'),
...
INSERT INTO `details` (`detail_id`, `sales_id`, `product_id`, `quantity`) VALUES
(14, 9, 11, 2),
(15, 9, 13, 5),
(16, 9, 3, 2),
(17, 9, 1, 3),
...
CREATE TABLE `images` (
  ...
  `img_name` varchar(200) NOT NULL COMMENT 'tên ảnh',
  `product_id` int(10) NOT NULL COMMENT 'id sản phẩm',
  `color_id` int(10) NOT NULL COMMENT 'id màu ảnh'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `orders` (
  ...
  `order-date` date NOT NULL COMMENT 'ngày đặt hàng',
...
CREATE TABLE `users` (
  ...
  `type` bit(1) DEFAULT NULL COMMENT '1 là admin',
  `firstname` varchar(50) DEFAULT NULL,
  `lastname` varchar(50) DEFAULT NULL,
  `address` text DEFAULT NULL,
  `phone_number` varchar(10) DEFAULT NULL,
  `photo` varchar(200) DEFAULT NULL,
  `status` bit(1) DEFAULT NULL COMMENT '1 là đang kích hoạt',
  `activate_code` varchar(15) DEFAULT NULL,
  `reset_code` varchar(15) DEFAULT NULL,
  `created_on` date DEFAULT NULL,
  `sex` varchar(10) DEFAULT NULL COMMENT 'giới tính'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `users` (`user_id`, `email`, `password`, `type`, `firstname`, `lastname`, `address`, `phone_number`, `photo`, `status`, `activate_code`, `reset_code`, `created_on`, `sex`) VALUES
(1, 'admin@admin.com', '$2y$10$p0hmtSddm7vEByOsPU0zdO0sETYhosiFU/B0nQsXotSAawiF4IrXe', b'1', 'Code', 'Projects', '', '', 'thanos1.jpg', b'1', '', '', '2018-05-01', ''),
(9, 'harry@den.com', '$2y$10$Oongyx.Rv0Y/vbHGOxywl.qf18bXFiZOcEaI4ZpRRLzFNGKAhObSC', b'0', 'Harry', 'Den', 'Silay City, Negros Occidental', '0909273571', 'male2.png', b'1', 'k8FBpynQfqsv', 'wzPGkX5IODlTYHg', '2018-05-09', ''),
(12, 'christine@gmail.com', '$2y$10$ozW4c8r313YiBsf7HD7m6egZwpvoE983IHfZsPRxrO1hWXfPRpxHO', b'0', 'Christine', 'becker', 'demo', '7542214500', 'female3.jpg', b'1', '', '', '2018-07-09', ''),
(13, 'content@gmail.com', '$2y$10$DAeezOAJ2dZTfOZArGIGzOSwDMHR9Q8wFIMpsiu1VmI.BxM6Hv8iS', b'1', 'khanh quoc nguyen', '', 'fdsfsdafd', '0989878765', '', b'1', NULL, NULL, '2023-07-19', 'nam'),
(14, 'a@gmail.com', '$2y$10$k/Q.Pi6a3q8s18R7SdlsKe6az.lWjtlmpfmfpf662rHDo1zLqLEGm', b'0', 'khanh quoc nguyen', '', 'dfsadas', '0989878788', '', b'1', NULL, NULL, '2023-07-19', 'nam');
...
--
ALTER TABLE `color`
  MODIFY `color_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'color id';
...
--
ALTER TABLE `images`
  MODIFY `img_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'id ảnh';
...
--
ALTER TABLE `product_variants`
  MODIFY `variant_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'id biến thể';
...
--
ALTER TABLE `sizes`
  MODIFY `size_id` int(1) NOT NULL AUTO_INCREMENT COMMENT 'size id';
...
--
ALTER TABLE `details`
  ADD CONSTRAINT `details_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`),
  ADD CONSTRAINT `details_ibfk_2` FOREIGN KEY (`sales_id`) REFERENCES `sales` (`sale_id`);
...
ALTER TABLE `product_variants`
  ...
  ADD CONSTRAINT `img` FOREIGN KEY (`img_id`) REFERENCES `images` (`img_id`),
